...
select 
count(distinct user_id) as users, city,
...
select 
count(distinct user_id) as users_freq3, 
city 
from (
select user_id,city,count(*) as orders_count 
from  `main-assessment378120.main_assessment.orders`
...
select 
count(distinct user_id) as users_freq3_breakfast, 
city 
from (
select user_id,city,
